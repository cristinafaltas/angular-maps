...
app.config["MONGO_URI"] = "mongodb+srv://cristina:9wwDgRvhmpEVdCjt@cluster0.7nx5c.mongodb.net/myFirstDatabase?retryWrites=true&w=majority" #Importante qui va specificato il nome del DB
